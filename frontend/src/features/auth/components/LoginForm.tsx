...
export function LoginForm() {
  ...
  const vuaDangKy = searchParams.get("registered") === "1";
  const loiOauth = searchParams.get("oauth_error");
  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      {vuaDangKy && (
        <div className="mb-4 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-sm text-emerald-700">
          Đăng ký thành công. Vui lòng đăng nhập để bắt đầu học.
        </div>
      )}
      {loiOauth && (
